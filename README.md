...
Plugins are Python classes that subclass `PluginBase`. They receive market data, publish signals, and interact with the MessageBus. See **[PLUGIN_MANUAL.md](PLUGIN_MANUAL.md)** for the full authoring reference.
