...
class OrderFactory:
    ...
    @staticmethod
    def trailing_stop(action: str, quantity: Decimal, trailing_percent: float,
                      trail_stop_price: float) -> Order:
        """
        ...
        Args:
            action: "BUY" or "SELL"
            quantity: Number of shares/contracts
            trailing_percent: Trailing amount as percentage
            trail_stop_price: Initial stop price
    ...
    @staticmethod
    def trailing_stop_limit(action: str, quantity: Decimal, limit_offset: float,
                            trailing_amount: float, trail_stop_price: float) -> Order:
    ...
    @staticmethod
    def pegged_to_midpoint(action: str, quantity: Decimal, offset: float,
    ...
    @staticmethod
    def relative(action: str, quantity: Decimal, price_cap: float,
                 offset_amount: float) -> Order:
        """
