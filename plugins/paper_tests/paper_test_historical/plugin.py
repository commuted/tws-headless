...
_CASES: List[HistoricalTestCase] = [
    ...
    HistoricalTestCase(
        ...
        min_bars=60,
        timeout=30.0,
        notes="AAPL 5-min bars, 2 days — guarantees ≥1 full RTH day (~78 bars) even when run intraday",
    ),
    HistoricalTestCase(
    ...
    HistoricalTestCase(
        ...
        min_bars=80,
        timeout=30.0,
        notes="EUR.USD hourly bars, 1 week — expect ~120 bars (5 trading days × 24h)",
    ),
]
